...
from protocols import OneOfNCloud
...
def one_of_n_send_ciphertexts(messages_provider, args_for_provider, protocol_name):
...
def _messages_provider_func_for_one_of_two(data):
...
routes.append(dict(
    ...
    view_func=one_of_n_send_ciphertexts(
        gen_example_messages, _NUM_OF_MESSAGES, PROTOCOL_NAME),
...
routes.append(dict(
    ...
    view_func=one_of_two_send_ciphertexts(
        _messages_provider_func_for_one_of_two, PROTOCOL_NAME),
    options=dict(methods=['POST']),
